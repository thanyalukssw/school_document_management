...
<head>
    ...
    <title>School e-Office Management System</title>
    ...
    <div id="loginModal" class="min-h-screen flex items-center justify-center p-4">
        <div class="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
            <div class="text-center mb-6">
                ...
                <h2 class="text-2xl font-bold text-gray-900">School e-Office Management</h2>
            ...
            <div class="max-w-7xl mx-auto px-4 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold">School e-Office Management</h1>
